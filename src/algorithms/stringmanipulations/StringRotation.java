...
public class StringRotation {
    public static void main(String[] args) {
        ...
        String s1s1 = s1 + s1;
        System.out.println("s2 is a rotated string of s1: " + (s1.length() == s2.length() && s1s1.contains(s1))); // contains method runs a for loop to find a substring. So it takes some execution time, may be O(n).
